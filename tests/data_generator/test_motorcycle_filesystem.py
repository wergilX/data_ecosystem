...
@patch(
    "data_generator.generators.motorcycle_generator.asdict", return_value={"vin": "x"}
)
@patch("data_generator.generators.motorcycle_generator.json.dump")
@patch("data_generator.generators.motorcycle_generator.open", new_callable=mock_open)
...
@patch("data_generator.generators.motorcycle_generator.Path.mkdir")
@patch("data_generator.generators.motorcycle_generator.open", new_callable=mock_open)
@patch("data_generator.generators.motorcycle_generator.json.dump")
...
def test_written_content_is_valid_json(mock_file, generator):
    ...
    data = {"vin": "TESTVIN123"}
    with patch(
        "data_generator.generators.motorcycle_generator.asdict", return_value=data
    ):
